...
-- Args : [Arg {argCName = "argc", argType = TBasicType TInt, direction = DirectionIn, mayBeNull = False, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferNothing},Arg {argCName = "argv", argType = TBasicType TUTF8, direction = DirectionIn, mayBeNull = False, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferNothing},Arg {argCName = "num_checks", argType = TBasicType TInt, direction = DirectionIn, mayBeNull = False, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferNothing},Arg {argCName = "sizeof_GtkWindow", argType = TBasicType TUInt64, direction = DirectionIn, mayBeNull = False, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferNothing},Arg {argCName = "sizeof_GtkBox", argType = TBasicType TUInt64, direction = DirectionIn, mayBeNull = False, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferNothing}]
-- Lengths : []
-- returnType : Just (TBasicType TBoolean)
-- throws : False
-- Skip return : False

foreign import ccall "gtk_init_check_abi_check" gtk_init_check_abi_check :: 
    Int32 ->                                -- argc : TBasicType TInt
    CString ->                              -- argv : TBasicType TUTF8
    Int32 ->                                -- num_checks : TBasicType TInt
    Word64 ->                               -- sizeof_GtkWindow : TBasicType TUInt64
    Word64 ->                               -- sizeof_GtkBox : TBasicType TUInt64
    IO CInt
...
initCheckAbiCheck ::
    ...
    -> T.Text                               -- argv
    -> Int32                                -- numChecks
    -> Word64                               -- sizeofGtkWindow
    -> Word64                               -- sizeofGtkBox
    -> m Bool                               -- result
initCheckAbiCheck argc argv numChecks sizeofGtkWindow sizeofGtkBox = liftIO $ do
    argv' <- textToCString argv
    result <- gtk_init_check_abi_check argc argv' numChecks sizeofGtkWindow sizeofGtkBox
    let result' = (/= 0) result
    freeMem argv'
    return result'
...
foreign import ccall "gtk_init_abi_check" gtk_init_abi_check :: 
    Int32 ->                                -- argc : TBasicType TInt
    CString ->                              -- argv : TBasicType TUTF8
    Int32 ->                                -- num_checks : TBasicType TInt
    Word64 ->                               -- sizeof_GtkWindow : TBasicType TUInt64
...
initAbiCheck ::
    ...
    -> Word64                               -- sizeofGtkBox
    -> m ()                                 -- result
initAbiCheck argc argv numChecks sizeofGtkWindow sizeofGtkBox = liftIO $ do
    argv' <- textToCString argv
    gtk_init_abi_check argc argv' numChecks sizeofGtkWindow sizeofGtkBox
    freeMem argv'
    return ()
