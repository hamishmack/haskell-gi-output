...
base47PKGS="GLib GObject Atk Gio Soup cairo Pango PangoCairo GdkPixbuf Gdk Gtk GtkSource GIRepository Poppler JavaScriptCore-3.0 WebKit Notify"
...
if [[ "$unamestr" == 'Darwin' ]]; then
    ...
    extraPKGS="JavaScriptCore-4.0 WebKit2 WebKit2WebExtension Vte"
fi
