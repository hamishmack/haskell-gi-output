...
pattern SYSDEF_AF_INET6 = 23 :: Int32
...
pattern POLLFD_FORMAT = "%#llx" :: T.Text
...
pattern MODULE_SUFFIX = "dll" :: T.Text
...
pattern GUINTPTR_FORMAT = "llu" :: T.Text


pattern GUINT64_FORMAT = "llu" :: T.Text
...
pattern GSSIZE_MODIFIER = "z" :: T.Text


pattern GSSIZE_FORMAT = "zi" :: T.Text


pattern GSIZE_MODIFIER = "z" :: T.Text


pattern GSIZE_FORMAT = "zu" :: T.Text
...
pattern GINTPTR_MODIFIER = "ll" :: T.Text


pattern GINTPTR_FORMAT = "lli" :: T.Text


pattern GINT64_MODIFIER = "ll" :: T.Text


pattern GINT64_FORMAT = "lli" :: T.Text
