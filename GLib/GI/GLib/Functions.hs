...
-- ** win32GetPackageInstallationDirectoryUtf8
    win32GetPackageInstallationDirectoryUtf8,


-- ** win32GetPackageInstallationSubdirectoryUtf8
    win32GetPackageInstallationSubdirectoryUtf8,
...
-- Args : [Arg {argCName = "utf8filename", argType = TBasicType TUTF8, direction = DirectionIn, mayBeNull = False, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferNothing}]
-- Lengths : []
-- returnType : Just (TBasicType TUTF8)
-- throws : False
-- Skip return : False

foreign import ccall "g_win32_locale_filename_from_utf8" g_win32_locale_filename_from_utf8 :: 
    CString ->                              -- utf8filename : TBasicType TUTF8
    IO CString
...
win32LocaleFilenameFromUtf8 ::
    ...
    T.Text                                  -- utf8filename
    -> m T.Text                             -- result
win32LocaleFilenameFromUtf8 utf8filename = liftIO $ do
    utf8filename' <- textToCString utf8filename
    result <- g_win32_locale_filename_from_utf8 utf8filename'
    checkUnexpectedReturnNULL "g_win32_locale_filename_from_utf8" result
    result' <- cstringToText result
    freeMem result
    freeMem utf8filename'
    return result'
...
foreign import ccall "g_win32_getlocale" g_win32_getlocale :: 
    IO CString
...
win32Getlocale ::
    (MonadIO m) =>
    m T.Text                                -- result
win32Getlocale  = liftIO $ do
    result <- g_win32_getlocale
    checkUnexpectedReturnNULL "g_win32_getlocale" result
    result' <- cstringToText result
    freeMem result
    return result'
...
foreign import ccall "g_win32_get_windows_version" g_win32_get_windows_version :: 
    IO Word32

{-# DEPRECATED win32GetWindowsVersion ["(Since version 2.44)","Be aware that for Windows 8.1 and Windows Server","2012 R2 and later, this will return 62 unless the application is","manifested for Windows 8.1/Windows Server 2012 R2, for example.","MSDN stated that GetVersion(), which is used here, is subject to","further change or removal after Windows 8.1."]#-}
win32GetWindowsVersion ::
    (MonadIO m) =>
    m Word32                                -- result
win32GetWindowsVersion  = liftIO $ do
    result <- g_win32_get_windows_version
    return result


-- function g_win32_get_system_data_dirs_for_module
-- Args : [Arg {argCName = "address_of_function", argType = TBasicType TPtr, direction = DirectionIn, mayBeNull = True, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferNothing}]
-- Lengths : []
-- returnType : Just (TCArray True (-1) (-1) (TBasicType TUTF8))
-- throws : False
-- Skip return : False

foreign import ccall "g_win32_get_system_data_dirs_for_module" g_win32_get_system_data_dirs_for_module :: 
    Ptr () ->                               -- address_of_function : TBasicType TPtr
    IO (Ptr CString)


win32GetSystemDataDirsForModule ::
    (MonadIO m) =>
    Ptr ()                                  -- addressOfFunction
    -> m [T.Text]                           -- result
win32GetSystemDataDirsForModule addressOfFunction = liftIO $ do
    result <- g_win32_get_system_data_dirs_for_module addressOfFunction
    checkUnexpectedReturnNULL "g_win32_get_system_data_dirs_for_module" result
    result' <- unpackZeroTerminatedUTF8CArray result
    return result'


-- function g_win32_get_package_installation_subdirectory_utf8
-- Args : [Arg {argCName = "package", argType = TBasicType TUTF8, direction = DirectionIn, mayBeNull = False, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferNothing},Arg {argCName = "dll_name", argType = TBasicType TUTF8, direction = DirectionIn, mayBeNull = False, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferNothing},Arg {argCName = "subdir", argType = TBasicType TUTF8, direction = DirectionIn, mayBeNull = False, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferNothing}]
-- Lengths : []
-- returnType : Just (TBasicType TUTF8)
-- throws : False
-- Skip return : False

foreign import ccall "g_win32_get_package_installation_subdirectory_utf8" g_win32_get_package_installation_subdirectory_utf8 :: 
    CString ->                              -- package : TBasicType TUTF8
    CString ->                              -- dll_name : TBasicType TUTF8
...
win32GetPackageInstallationSubdirectoryUtf8 ::
    ...
    -> T.Text                               -- subdir
    -> m T.Text                             -- result
win32GetPackageInstallationSubdirectoryUtf8 package dllName subdir = liftIO $ do
    package' <- textToCString package
    dllName' <- textToCString dllName
    subdir' <- textToCString subdir
    result <- g_win32_get_package_installation_subdirectory_utf8 package' dllName' subdir'
    checkUnexpectedReturnNULL "g_win32_get_package_installation_subdirectory_utf8" result
    result' <- cstringToText result
    freeMem result
    freeMem package'
    freeMem dllName'
...
-- function g_win32_get_package_installation_directory_utf8
-- Args : [Arg {argCName = "package", argType = TBasicType TUTF8, direction = DirectionIn, mayBeNull = False, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferNothing},Arg {argCName = "dll_name", argType = TBasicType TUTF8, direction = DirectionIn, mayBeNull = False, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferNothing}]
-- Lengths : []
-- returnType : Just (TBasicType TUTF8)
-- throws : False
...
foreign import ccall "g_win32_get_package_installation_directory_utf8" g_win32_get_package_installation_directory_utf8 :: 
    CString ->                              -- package : TBasicType TUTF8
    CString ->                              -- dll_name : TBasicType TUTF8
    IO CString
...
win32GetPackageInstallationDirectoryUtf8 ::
    ...
    -> T.Text                               -- dllName
    -> m T.Text                             -- result
win32GetPackageInstallationDirectoryUtf8 package dllName = liftIO $ do
    package' <- textToCString package
    dllName' <- textToCString dllName
    result <- g_win32_get_package_installation_directory_utf8 package' dllName'
    checkUnexpectedReturnNULL "g_win32_get_package_installation_directory_utf8" result
    result' <- cstringToText result
    freeMem result
    freeMem package'
    freeMem dllName'
...
-- Args : [Arg {argCName = "hmodule", argType = TBasicType TPtr, direction = DirectionIn, mayBeNull = True, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferNothing}]
-- Lengths : []
-- returnType : Just (TBasicType TUTF8)
-- throws : False
-- Skip return : False

foreign import ccall "g_win32_get_package_installation_directory_of_module" g_win32_get_package_installation_directory_of_module :: 
    Ptr () ->                               -- hmodule : TBasicType TPtr
    IO CString
...
win32GetPackageInstallationDirectoryOfModule ::
    ...
    Ptr ()                                  -- hmodule
    -> m T.Text                             -- result
win32GetPackageInstallationDirectoryOfModule hmodule = liftIO $ do
    result <- g_win32_get_package_installation_directory_of_module hmodule
    checkUnexpectedReturnNULL "g_win32_get_package_installation_directory_of_module" result
    result' <- cstringToText result
    freeMem result
    return result'


-- function g_win32_get_command_line
-- Args : []
-- Lengths : []
-- returnType : Just (TCArray True (-1) (-1) (TBasicType TUTF8))
-- throws : False
...
foreign import ccall "g_win32_get_command_line" g_win32_get_command_line :: 
    IO (Ptr CString)
...
win32GetCommandLine ::
    (MonadIO m) =>
    m [T.Text]                              -- result
win32GetCommandLine  = liftIO $ do
    result <- g_win32_get_command_line
    checkUnexpectedReturnNULL "g_win32_get_command_line" result
    result' <- unpackZeroTerminatedUTF8CArray result
...
-- function g_win32_ftruncate
-- Args : [Arg {argCName = "f", argType = TBasicType TInt, direction = DirectionIn, mayBeNull = False, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferNothing},Arg {argCName = "size", argType = TBasicType TUInt, direction = DirectionIn, mayBeNull = False, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferNothing}]
-- Lengths : []
-- returnType : Just (TBasicType TInt)
-- throws : False
-- Skip return : False

foreign import ccall "g_win32_ftruncate" g_win32_ftruncate :: 
    Int32 ->                                -- f : TBasicType TInt
...
win32Ftruncate ::
    ...
    -> Word32                               -- size
    -> m Int32                              -- result
win32Ftruncate f size = liftIO $ do
    result <- g_win32_ftruncate f size
    return result


-- function g_win32_error_message
-- Args : [Arg {argCName = "error", argType = TBasicType TInt, direction = DirectionIn, mayBeNull = False, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferNothing}]
-- Lengths : []
-- returnType : Just (TBasicType TUTF8)
-- throws : False
-- Skip return : False

foreign import ccall "g_win32_error_message" g_win32_error_message :: 
    Int32 ->                                -- error : TBasicType TInt
    IO CString
...
win32ErrorMessage ::
    ...
    Int32                                   -- error_
    -> m T.Text                             -- result
win32ErrorMessage error_ = liftIO $ do
    result <- g_win32_error_message error_
    checkUnexpectedReturnNULL "g_win32_error_message" result
    result' <- cstringToText result
    freeMem result
    return result'
...
-- Args : [Arg {argCName = "major", argType = TBasicType TInt, direction = DirectionIn, mayBeNull = False, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferNothing},Arg {argCName = "minor", argType = TBasicType TInt, direction = DirectionIn, mayBeNull = False, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferNothing},Arg {argCName = "spver", argType = TBasicType TInt, direction = DirectionIn, mayBeNull = False, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferNothing},Arg {argCName = "os_type", argType = TInterface "GLib" "Win32OSType", direction = DirectionIn, mayBeNull = False, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferNothing}]
-- Lengths : []
-- returnType : Just (TBasicType TBoolean)
-- throws : False
-- Skip return : False

foreign import ccall "g_win32_check_windows_version" g_win32_check_windows_version :: 
    Int32 ->                                -- major : TBasicType TInt
    Int32 ->                                -- minor : TBasicType TInt
    Int32 ->                                -- spver : TBasicType TInt
    CUInt ->                                -- os_type : TInterface "GLib" "Win32OSType"
    IO CInt
...
win32CheckWindowsVersion ::
    ...
    -> Win32OSType                          -- osType
    -> m Bool                               -- result
win32CheckWindowsVersion major minor spver osType = liftIO $ do
    let osType' = (fromIntegral . fromEnum) osType
    result <- g_win32_check_windows_version major minor spver osType'
    let result' = (/= 0) result
    return result'
...
-- function g_stat
-- Args : [Arg {argCName = "filename", argType = TBasicType TUTF8, direction = DirectionIn, mayBeNull = False, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferNothing},Arg {argCName = "buf", argType = TInterface "GLib" "StatBuf", direction = DirectionIn, mayBeNull = False, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferNothing}]
-- Lengths : []
-- returnType : Just (TBasicType TInt)
-- throws : False
-- Skip return : False
...
foreign import ccall "g_stat" g_stat :: 
    CString ->                              -- filename : TBasicType TUTF8
    Ptr StatBuf ->                          -- buf : TInterface "GLib" "StatBuf"
    IO Int32
...
-- Args : [Arg {argCName = "pid", argType = TBasicType TPtr, direction = DirectionIn, mayBeNull = False, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferNothing}]
-- Lengths : []
-- returnType : Nothing
-- throws : False
-- Skip return : False
...
-- Args : [Arg {argCName = "working_directory", argType = TBasicType TUTF8, direction = DirectionIn, mayBeNull = True, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferNothing},Arg {argCName = "argv", argType = TCArray True (-1) (-1) (TBasicType TUTF8), direction = DirectionIn, mayBeNull = False, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferNothing},Arg {argCName = "envp", argType = TCArray True (-1) (-1) (TBasicType TUTF8), direction = DirectionIn, mayBeNull = True, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferNothing},Arg {argCName = "flags", argType = TInterface "GLib" "SpawnFlags", direction = DirectionIn, mayBeNull = False, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferNothing},Arg {argCName = "child_setup", argType = TInterface "GLib" "SpawnChildSetupFunc", direction = DirectionIn, mayBeNull = True, argScope = ScopeTypeAsync, argClosure = 5, argDestroy = -1, argCallerAllocates = False, transfer = TransferNothing},Arg {argCName = "user_data", argType = TBasicType TPtr, direction = DirectionIn, mayBeNull = True, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferNothing},Arg {argCName = "child_pid", argType = TBasicType TPtr, direction = DirectionOut, mayBeNull = False, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferEverything},Arg {argCName = "standard_input", argType = TBasicType TInt, direction = DirectionOut, mayBeNull = False, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferEverything},Arg {argCName = "standard_output", argType = TBasicType TInt, direction = DirectionOut, mayBeNull = False, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferEverything},Arg {argCName = "standard_error", argType = TBasicType TInt, direction = DirectionOut, mayBeNull = False, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferEverything}]
-- Lengths : []
-- returnType : Just (TBasicType TBoolean)
-- throws : True
-- Skip return : False
...
foreign import ccall "g_spawn_async_with_pipes_utf8" g_spawn_async_with_pipes_utf8 :: 
    ...
    FunPtr SpawnChildSetupFuncC ->          -- child_setup : TInterface "GLib" "SpawnChildSetupFunc"
    Ptr () ->                               -- user_data : TBasicType TPtr
    Ptr (Ptr ()) ->                         -- child_pid : TBasicType TPtr
...
spawnAsyncWithPipes ::
    ...
    -> [SpawnFlags]                         -- flags
    -> Maybe (SpawnChildSetupFunc)          -- childSetup
    -> m ((Ptr ()),Int32,Int32,Int32)       -- result
...
-- Args : [Arg {argCName = "working_directory", argType = TBasicType TUTF8, direction = DirectionIn, mayBeNull = True, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferNothing},Arg {argCName = "argv", argType = TCArray True (-1) (-1) (TBasicType TUTF8), direction = DirectionIn, mayBeNull = False, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferNothing},Arg {argCName = "envp", argType = TCArray True (-1) (-1) (TBasicType TUTF8), direction = DirectionIn, mayBeNull = True, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferNothing},Arg {argCName = "flags", argType = TInterface "GLib" "SpawnFlags", direction = DirectionIn, mayBeNull = False, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferNothing},Arg {argCName = "child_setup", argType = TInterface "GLib" "SpawnChildSetupFunc", direction = DirectionIn, mayBeNull = True, argScope = ScopeTypeAsync, argClosure = 5, argDestroy = -1, argCallerAllocates = False, transfer = TransferNothing},Arg {argCName = "user_data", argType = TBasicType TPtr, direction = DirectionIn, mayBeNull = True, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferNothing},Arg {argCName = "child_pid", argType = TBasicType TPtr, direction = DirectionOut, mayBeNull = False, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferEverything}]
-- Lengths : []
-- returnType : Just (TBasicType TBoolean)
-- throws : True
-- Skip return : False
...
-- function g_rename
-- Args : [Arg {argCName = "oldfilename", argType = TBasicType TUTF8, direction = DirectionIn, mayBeNull = False, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferNothing},Arg {argCName = "newfilename", argType = TBasicType TUTF8, direction = DirectionIn, mayBeNull = False, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferNothing}]
-- Lengths : []
-- returnType : Just (TBasicType TInt)
-- throws : False
-- Skip return : False
...
foreign import ccall "g_rename" g_rename :: 
    CString ->                              -- oldfilename : TBasicType TUTF8
    CString ->                              -- newfilename : TBasicType TUTF8
    IO Int32
...
rename ::
    ...
    -> T.Text                               -- newfilename
    -> m Int32                              -- result
rename oldfilename newfilename = liftIO $ do
    oldfilename' <- textToCString oldfilename
    newfilename' <- textToCString newfilename
...
open ::
    ...
    -> Int32                                -- mode
    -> m Int32                              -- result
open filename flags mode = liftIO $ do
    filename' <- textToCString filename
...
-- function g_freopen
-- Args : [Arg {argCName = "filename", argType = TBasicType TUTF8, direction = DirectionIn, mayBeNull = False, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferNothing},Arg {argCName = "mode", argType = TBasicType TUTF8, direction = DirectionIn, mayBeNull = False, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferNothing},Arg {argCName = "stream", argType = TBasicType TPtr, direction = DirectionIn, mayBeNull = True, argScope = ScopeTypeInvalid, argClosure = -1, argDestroy = -1, argCallerAllocates = False, transfer = TransferNothing}]
-- Lengths : []
-- returnType : Just (TBasicType TPtr)
-- throws : False
-- Skip return : False
...
freopen ::
    ...
    -> Ptr ()                               -- stream
    -> m (Ptr ())                           -- result
freopen filename mode stream = liftIO $ do
    filename' <- textToCString filename
...
foreign import ccall "g_abort" g_abort :: 
    IO ()
