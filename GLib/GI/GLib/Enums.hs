...
data Win32OSType = 
      Win32OSTypeAny
    | Win32OSTypeWorkstation
    | Win32OSTypeServer
    | AnotherWin32OSType Int
    deriving (Show, Eq)

instance Enum Win32OSType where
    fromEnum Win32OSTypeAny = 0
    fromEnum Win32OSTypeWorkstation = 1
    fromEnum Win32OSTypeServer = 2
    fromEnum (AnotherWin32OSType k) = k

    toEnum 0 = Win32OSTypeAny
    toEnum 1 = Win32OSTypeWorkstation
    toEnum 2 = Win32OSTypeServer
    toEnum k = AnotherWin32OSType k
